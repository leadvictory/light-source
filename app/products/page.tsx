        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">$45,231 total value</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardHeader>
              ...
              <CardDescription>Add, edit, and assign products to clients</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600">
                View all products, manage inventory, and handle client assignments
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardHeader>
              ...
              <CardDescription>Manage clients, buildings, and tenant assignments</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600">Add new clients, manage their buildings and floor assignments</p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardHeader>
              ...
              <CardDescription>View and process client orders</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600">Review pending orders, update status, and manage fulfillment</p>
            </CardContent>
          </Card>
        </div>
