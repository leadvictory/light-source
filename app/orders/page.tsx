...
export default function OrdersPage() {
  ...
  const [userRole] = useState<"Owner" | "SuperClient" | "Client" | "Tenant">("Owner"); // This would come from auth context
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="p-6">
        <div className="bg-white rounded-lg shadow">
          ...
          {/* Orders List */}
          <div className="p-4">
            {groupedOrders ? ( // Owner view - grouped by company
